...
# добавление слоя пулинга - т.е. уменьшение размерности пространства признаков,
# уменьшением количество параметров и вычислений в сети, следовательно, предотвращение переобучение.
...
model.add(layers.Conv2D(64, (3, 3), activation='relu'))
# добавление слоя “выравнивания” - т.е. преобразование многомерный тензор в одномерный тензор,
# что позволяет передавать данные в полносвязные слои
