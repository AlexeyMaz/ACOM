...
namespace MyGradientBorder
{
    public class GradientBorder
    {
        ...
        private List<List<int>> _sobelOperatorX = new List<List<int>>()
        {
            new List<int>() { -1, 0, 1 },
            new List<int>() { -2, 0, 2 },
            new List<int>() { -1, 0, 1 }
        };
        private List<List<int>> _sobelOperatorY = new List<List<int>>()
        {
            new List<int>() { -1, -2, -1 },
            new List<int>() { 0, 0, 0 },
            new List<int>() { 1, 2, 1 }
        ...
        private void GetGradientComponents(List<List<int>> originalImage)
        {
            ...
            _gradientVectorMatrix = new List<List<(int, int)>>();
            _gradientVectorAngles = new List<List<int>>();
            _gradientVectorLengths = new List<List<double>>();
            _maxLength = -100000;
